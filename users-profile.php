                        ...
                        <div class="card">
                            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                ...
                                <form action="users-profile.php" method="POST">
                                    <input name="myActionName" class=" btn btn-dark" type="submit"
                                        value="Выйти из сайта " />
                                    <?php
                    ...
                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-change-password">Изменить пароль</button>
                                ...
                                <div class="tab-content pt-2">
                                    ...
                                    <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-md-4 label" id="">Номер телефона</div>
                                            <div class="col-lg-9 col-md-8"><?= $_SESSION['user']['telephone'];?></div>
                                        </div>


                                        <div class="row">
                                            <div class="col-lg-3 col-md-4 label">Тип пользователя</div>
                                            <?php 
                                              if($_SESSION['user']['admin'] == 1){
                                                echo '<div class="col-lg-9 col-md-8">Организатор</div>';
                                              } else{
                                                echo '<div class="col-lg-9 col-md-8">Обычный</div>';
                                              }
                                            ?>
                                        </div>
                                    </div>
