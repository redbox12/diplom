...
if($_SESSION['user']['admin'] == 1){
    ...
    //                         <input type="hidden" name="id_task'.$j.'" value="'.$id_task.'">
    //                         <input type="hidden" name="id_type'.$j.'" value="'.$id_type.'">
    //                         <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Кол-во людей достаточно!">
    //                         <button class="btn btn-success btn-sm response-task" type="button" disabled>Откликнуться</button>
    //                     </div>
    ...
    //         $j++;
    // } else { //вывод для исполнителя

       
        
        if($people_feedback < $people_amout and mysqli_num_rows($task_id_human_otkl) === 0){//проверка на записанные задания
            $all_task[] = ' 
            <div class= "card mb-1 response">
                    <div class="card-body">
                    <div class="row mb-2">
    ...
    // <div class="row">
    //     <div class="col mt-2 " >
    //         <input type="hidden" id="" name="id_task'.$j.'" value="'.$id_task.'">
    //         <input type="hidden" name="id_type'.$j.'" value="'.$id_type.'">
    //         <input type="hidden" name="id_human'.$j.'" value="'.$_SESSION['user']['id'].'">
    //         <button class="btn btn-success btn-sm response-task">Откликнуться</button>
    //         <button class="btn btn-primary btn-sm ms-1 details">Подробнее...</button>                            
    //     </div>
