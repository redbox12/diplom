                        ...
                        <div class="card-body mt-5">
                            ...
                            <div class="tab-content" id="myTabContent">
                                    ...
                                    <form>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-lg-6 col-sm-12">
                                                <label class="form-label">Номер телефона для перевода</label>
                                                <input type="tel" name="telephone_mtrl" class="form-control"
                                                    id="yourTelephone" placeholder="8 (925) 086-86-37" required>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                                            <div class="col-lg-6 col-sm-12">
                                                ...
                                                <input type="text" class="mask-card-number form-control"
                                                    placeholder="9999 9999 9999 9999" name="card_mtrl" required>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-lg-6 col-sm-12">
                                ...
                                <div class="tab-pane fade" id="pills-contact" role="tabpanel"
                                    ...
                                    cumque.
                                    Accusantium quibusdam perspiciatis qui qui omnis magnam. Officiis accusamus
                                    impedit
